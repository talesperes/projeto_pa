...
class Usuario_Model extends MY_Model
{
	...
	public $fillable = array('id_usuario', 'nome', 'sexo', 'email', 'telefone', 'nascimento', 'cidade', 'estado', 'fk_u_cidade', 'fk_u_escolaridade', 'descricao', 'habilidade', 'curso_extra', 'pontuacao', 'num_rank', 'foto', 'capa', 'senha', 'instagram', 'twitter', 'github', 'facebook', 'linkedin','imagem');
