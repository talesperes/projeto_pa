			...
			<div class="row py-3 justify-content-center">
				<div class="col-8">
					<form class="form-inline d-flex justify-content-center md-form form-sm" method="get" action="<?=site_url('/projeto')?>">
					  <input class="form-control form-control-lg mr-3 w-75" name="search" type="text" placeholder="Pesquise por título" aria-label="Procurar">
				...
				<div class="col-md-9">
					...
					<div class="row mt-4">
						<div class="col-md-2 mb-2">
							<a href="<?=site_url('projeto?area=arquitetura')?>" class="btn btn-warning btn-block" role="button" style="border-radius: 0px;">Arquitetura</a>
						</div>
						<div class="col-md-2 mb-2">
							<a href="<?=site_url('projeto?area=biologia')?>" class="btn btn-warning btn-block" role="button" style="border-radius: 0px;">Biologia</a>
						</div>
						<div class="col-md-2 mb-2">
							<a href="<?=site_url('projeto?area=computacao')?>" class="btn btn-warning btn-block" role="button" style="border-radius: 0px;">Computação</a>
						</div>
						<div class="col-md-2 mb-2">
							<a href="<?=site_url('projeto?area=engenharia')?>" class="btn btn-warning btn-block" role="button" style="border-radius: 0px;">Engenharia</a>
						</div>
						<div class="col-md-2 mb-2">
							<a href="<?=site_url('projeto?area=psicologia')?>" class="btn btn-warning btn-block" role="button" style="border-radius: 0px;">Psicologia</a>
						</div>
						<div class="col-md-2 mb-2">
							<a href="<?=site_url('projeto')?>" class="btn btn-primary btn-block" role="button" style="border-radius: 0px;">Ver todas</a>
						</div>
					</div>
